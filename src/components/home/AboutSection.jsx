            ...
            <ScrollStackItem itemClassName="bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/90 dark:to-cyan-900/90 backdrop-blur-md border border-blue-200 dark:border-blue-700/50 shadow-xl overflow-hidden min-h-[400px]">
              <div className="flex flex-col md:flex-row gap-8 md:gap-12 h-full">
                ...
                <div className="flex-1 flex flex-col justify-center py-4">
                  ...
                  <div className="space-y-4 text-xl text-muted-foreground leading-relaxed">
                    <p>
                      We empower professionals to apply their skills in real FM
                      environments with confidence and measurable results.
                    </p>
                    <p>
                      Our training helps organizations optimize performance,
                      enhance sustainability, and reduce operational costs.
                    </p>
                    <p>
                      Through continuous skill development, we contribute to
                      building stronger, future-ready FM teams.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <ScrollStackItem itemClassName="bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/90 dark:to-cyan-900/90 backdrop-blur-md border border-blue-200 dark:border-blue-700/50 shadow-xl overflow-hidden min-h-[400px]">
              <div className="flex flex-col md:flex-row gap-8 md:gap-12 h-full">
                ...
                <div className="flex-1 flex flex-col justify-center py-4">
                  ...
                  <div className="space-y-4 text-xl text-muted-foreground leading-relaxed">
                    <p>
                      We are committed to delivering training that is reliable,
                      relevant, and rooted in real FM challenges.
                    </p>
                    <p>
                      Every participant receives the tools, mentorship, and
                      support needed to excel in their career.
                    </p>
                    <p>
                      Our promise is to consistently evolve our programs so they
                      remain aligned with global FM standards.
                    </p>
                  </div>
                </div>
              </div>
